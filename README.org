...
** Installation
*** ELPA
    ~mu4e-alert~ will be available on [[http://melpa.org/#/restart-emacs][MELPA]] [[https://github.com/milkypostman/melpa/pull/3207][soon]]. Please follow the instructions on
